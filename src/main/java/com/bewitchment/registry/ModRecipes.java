...
public class ModRecipes {
	...
	private static void craftingRecipesInit() {
		ForgeRegistries.RECIPES.register(new RecipeTippedArrow() {
			...
			public ItemStack getCraftingResult(InventoryCrafting inv) {
				...
				if (PotionUtils.getPotionFromItem(stack) == PotionTypes.EMPTY)
					stack.getTagCompound().setInteger("CustomPotionColor", PotionUtils.getPotionColorFromEffectList(PotionUtils.getFullEffectsFromItem(stack)));
				return stack;
			}
	...
	private static void altarInit() {
		...
		Util.registerAltarUpgradeItem(ModObjects.cold_iron_sword, new AltarUpgrade(AltarUpgrade.Type.SWORD, 0, 1.225));
		Util.registerAltarUpgradeItem(ModObjects.cleaver_sword, new AltarUpgrade(AltarUpgrade.Type.SWORD, 0, 1.35));
	...
	private static void athamePostInit() {
		...
		BewitchmentAPI.ATHAME_LOOT.put(e -> e instanceof EntityCambion, Sets.newHashSet(new ItemStack(ModObjects.hellhound_horn, 2), new ItemStack(ModObjects.heart, 1), new ItemStack(Items.ROTTEN_FLESH, 2), new ItemStack(ModObjects.ectoplasm, 1)));
	...
	protected static void addCauldronRecipes() {
		...
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "slimeball"), Collections.singletonList(Util.get(ModObjects.hoof)), Collections.singletonList(new ItemStack(Items.SLIME_BALL, 4))));
		...
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "ink_extraction"), Collections.singletonList(Util.get(ModObjects.blue_ink_cap)), Collections.singletonList(new ItemStack(ModObjects.ink_cap_dye, 4))));
		...
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "slimeball_alt"), Collections.singletonList(Util.get(ModObjects.toe_of_frog)), Collections.singletonList(new ItemStack(Items.SLIME_BALL, 1, 0))));
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "blood_alt"), Arrays.asList(Util.get(ModObjects.adders_fork), Util.get(ModObjects.adders_fork), Util.get(ModObjects.adders_fork), Util.get(ModObjects.adders_fork), Util.get(Items.GLASS_BOTTLE)), Collections.singletonList(new ItemStack(ModObjects.bottle_of_blood, 1, 0))));
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "blood_alt_2"), Arrays.asList(Util.get(ModObjects.tongue_of_dog), Util.get(ModObjects.tongue_of_dog), Util.get(Items.GLASS_BOTTLE)), Arrays.asList(new ItemStack(ModObjects.bottle_of_blood, 1), new ItemStack(Items.SLIME_BALL))));

		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "poison_potato"), Arrays.asList(Util.get(ModObjects.snake_venom), Util.get(Items.POTATO), Util.get(Items.POTATO), Util.get(Items.POTATO), Util.get(Items.POTATO)), Arrays.asList(new ItemStack(Items.POISONOUS_POTATO, 4), new ItemStack(Items.GLASS_BOTTLE))));
		...
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "soop_1"), Arrays.asList(Util.get(Items.BEETROOT), Util.get(Items.BEETROOT), Util.get(Items.BEETROOT), Util.get("salt"), Util.get(Items.BOWL)), Collections.singletonList(new ItemStack(Items.BEETROOT_SOUP))));
		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "soop_2"), Arrays.asList(Util.get(Blocks.BROWN_MUSHROOM), Util.get(Blocks.RED_MUSHROOM), Util.get("salt"), Util.get(Items.BOWL)), Collections.singletonList(new ItemStack(Items.MUSHROOM_STEW))));

		cauldronRecipes.add(new CauldronRecipe(new ResourceLocation(Bewitchment.MODID, "no_juniper_january"), Arrays.asList(Util.get(ModObjects.juniper_berries), Util.get(ModObjects.juniper_berries), Util.get(ModObjects.juniper_berries), Util.get(Items.SUGAR), Util.get(Items.GLASS_BOTTLE)), Collections.singletonList(new ItemStack(ModObjects.juniper_tea))));
	...
	protected static void addDistilleryRecipes() {
		...
		distilleryRecipes.add(new DistilleryRecipe(new ResourceLocation(Bewitchment.MODID, "fiery_unguent"), Arrays.asList(Util.get(Items.BLAZE_POWDER), Util.get(ModObjects.cloudy_oil), Util.get("tallow")), Collections.singletonList(new ItemStack(ModObjects.fiery_unguent))));
		...
		distilleryRecipes.add(new DistilleryRecipe(new ResourceLocation(Bewitchment.MODID, "bottled_hellfire"), Arrays.asList(Util.get(Items.GLASS_BOTTLE), Util.get("tallow"), Util.get("tallow"), Util.get(ModObjects.fiery_unguent), Util.get(ModObjects.dragons_blood_resin)), Arrays.asList(new ItemStack(ModObjects.bottled_hellfire), new ItemStack(ModObjects.empty_jar, 1))));
